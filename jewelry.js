...
addNewItem('Penny Anklet', 'bracelet', 'A crocheted anklet (that can also be worn as a bracelet) made from cotton string and pennies. It makes a lovely jingle as you walk. Great for salsa dancing! But maybe not great for libraries.', 'images/pennybracelet.jpg');
addNewItem('Round Leaf Pendant', 'necklace', 'This handmade wire wrapped pendant is made from a large bead from a broken necklace, a paperclip, and short pieces of electrical wire. The thin copper wire traces the outlines of the leaves that are embossed in the bead.', 'images/leafbead.jpg');
...
addNewItem('Paperclip Ring', 'ring', 'A handmade ring made from 4 paperclips and short pieces of copper electrical wire that had been hammered flat and wrapped around the sides.', 'images/ppclipring.jpg');
addNewItem('Copper Swirl Ring', 'ring', 'This ring is made from think copper electrical wire. It was formed my hammering the wire flat then shaping it on a mandrel.', 'images/swirlring.jpg');
...
addNewItem('Paperclip Bead Pendants', 'necklace', 'Wire wrapped bead pendants made from ordinary paperclips. The center pendant is inspired by the earth and moon', 'images/ppclipbeads.jpg');
...
addNewItem('Painted Hair Sticks', 'other', 'A collection of hand painted hair sticks, made from unused barbeque skewers that were cut short and filed down to remove the sharp point.', 'images/paintsticks.jpg' );
